...
import (
	...
	"github.com/CommerciumBlockchain/go-commercium/crypto/signify"
	"github.com/CommerciumBlockchain/go-commercium/internal/build"
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/CommerciumBlockchain/go-commercium/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "github.com/CommerciumBlockchain/go-commercium/mobile")
