...
```shell
go get github.com/commerciumfoundation/go-commercium/cmd/checkpoint-admin
```
...
*CHECKPOINT_HASH is obtained based on this [calculation method](https://github.com/commerciumfoundation/go-commercium/blob/master/params/config.go#L251).*
