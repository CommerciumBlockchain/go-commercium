...
```shell
go get github.com/CommerciumBlockchain/go-commercium/cmd/checkpoint-admin
```
...
*CHECKPOINT_HASH is obtained based on this [calculation method](https://github.com/CommerciumBlockchain/go-commercium/blob/master/params/config.go#L251).*
