...
For more details on writing automatic rules, please see the [rules spec](https://github.com/CommerciumBlockchain/go-commercium/blob/master/cmd/clef/rules.md).
